...
(function loadEndgameAdjudicationR1(){
  ...
  const styles=[
    ...
    ['./css/workspace-ux-plain-language-r1.css?v=20260825-r1','workspace-ux-plain-language-r1']
  ];
  const scripts=[
    ...
    ['./js/workspace-ux-plain-language-r1.js?v=20260825-r1','workspace-ux-plain-language-r1']
  ];
