...
BUILD_COMMANDS: tuple[tuple[str, ...], ...] = (
    ...
    command("scripts/build_web_of_lies_discovery_queue.py"),
    command("scripts/build_web_of_lies_baseline_packets.py"),
    command("scripts/build_web_of_lies_sep20_reconciliation_packets.py"),
    command("scripts/build_web_of_lies_source_promotion_control_packets.py"),
    command("scripts/build_web_of_lies_current_anchor_packets.py"),
    ...
    command("scripts/build_web_of_lies_sep20_reconciliation_packets.py", "--check"),
    command("scripts/build_web_of_lies_source_promotion_control_packets.py", "--check"),
