...
assert.deepEqual(finding('FALSE', 'KNOWING_FALSEHOOD_ESTABLISHED', 'BLOCKED_EVIDENCE_COMPLETION'), { label: 'Evidence review incomplete', key: 'pending' });
...
console.log('public reader layer: PASS - claim labels, facility status integrity, constituent drilldown, and structural public/internal boundary verified');
