...
assert.match(h16.claim, /DDG-121 and DDG-112.*transited the Strait/i);
assert.match(h16.editorial_note, /No Iranian retraction\/correction.*located/i);
assert.match(h16.editorial_note, /search result, not proof of universal absence/i);
assert.match(hormuzAug26.sources.S36.supports, /geometry at area level/i);
assert.match(hormuzAug26.sources.S36.supports, /rather than publishing a mine-by-mine coordinate ledger/i);
assert.match(hormuzAug26.sources.S37.supports, /16 Iranian mine-laying vessels/i);
assert.match(hormuzAug26.sources.S39.supports, /DDG-121.*DDG-112.*transited the Strait/i);
assert.match(hormuzAug26.sources.S40.supports, /Traffic Separation Scheme was safe and viable/i);
assert.match(hormuzAug26.hormuz_update.text, /no Iranian retraction or correction.*located/i);
assert.match(hormuzAug26.hormuz_update.text, /wholly dependent on Iran/i);
...
assert.match(hormuzAug26.status_overrides['Hormuz leverage'], /U\.S\. LANE-TESTING DEMONSTRATED/i);
