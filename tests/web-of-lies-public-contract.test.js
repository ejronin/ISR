...
assert.match(iaSource, /WOL applies “Fake analyst” because/);
assert.match(iaSource, /WOL applies “Yellow journalism” because/);
assert.match(iaSource, /unsupported analytical leaps, inference presented as fact, or basic verification failures/);
assert.match(iaSource, /verification failures alongside sensationalized or materially distorted presentation/);
