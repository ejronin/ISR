...
for token in (
    ...
    "python tests/web-of-lies-social-influence-tranche2b.test.py",
    "python tests/web-of-lies-social-influence-tranche2c.test.py",
    "python tests/web-of-lies-social-influence-tranche2d.test.py",
    "python tests/web-of-lies-social-influence-tranche2e.test.py",
    "python tests/web-of-lies-social-influence-tranche2f.test.py",
    "python tests/web-of-lies-social-influence-tranche2g.test.py",
    "python tests/web-of-lies-social-influence-tranche2h.test.py",
    "python tests/web-of-lies-social-influence-tranche2i.test.py",
    "python tests/web-of-lies-social-influence-tranche2k.test.py",
    "python tests/web-of-lies-source-discovery-scope.test.py",
    "python tests/web-of-lies-propagation-graph.test.py",
